...
$i18n = array(
	"TITLE"					=> "Ustawienia Google Map",	
	"DESCRIP"				=> "Plugin do wyświetlania map Google Maps na Twojej stronie.",
	"HOW"					=> "<b>Jak używać</b>",								
	...
	"DESC_SATELLITE"		=> "(wyświetla zdjęcia satelitarne)",
	...
	"IMAGE"					=> "Ścieżka/URL do obrazka markera",
	"INFO"					=> "Popup z dodatkowymi informacjami. Na przykład: nazwa, adres, telefon ...",	
	"SHADOW"				=> "Ścieżka/URL do obrazka cienia markera",
	"POPUP"					=> "Otwórz popup przy wczytywaniu mapy",
	"ID"					=> "Unikalna nazwa mapy",
	"ADD_NEW_MAP_BT"		=> "DODAJ NOWĄ MAPĘ",
	"DEL_MAP_QUEST"			=> "Na pewno chcesz usunąć tą mapę?",
	"DEL_ANCHOR_QUEST"		=> "Na pewno chcesz usunąć ten marker? ",
	"ALERT_ID_EXISTS"		=> "Mapa o takim ID! już istnieje!",	
	"TIT_MAP"				=> "Mapa:",
	"ICON"					=> "DOMYŚLNA IKONA",
	"ANCHORS"				=> "MARKERY",
	"CONTROLS"				=> "KONTROLKI",
	"ADV_SETTINGS_BT"		=> "USTAWIENIA ZAAWANSOWANE &nbsp;",
	"ICO_IMAGE_POS"			=> "Axis image",
	"ICO_SHADOW_POS"		=> "Axis shadow",
	"ADD_NEW_ANCHOR_BT"		=> "DODAJ NOWY MARKER",
	"ADD_NEW_ANCHOR_TX"		=> "The map can contain \"markers\" in various directions.<br/>Here you can configure.",
	"CTRL_PAN"				=> "Przyciski nawigacyjne",
	"CTRL_ZOOM"				=> "Powiększenie",
	"CTRL_MAPTYPE"			=> "Typ mapy",
	"CTRL_SCALE"			=> "Skala",
